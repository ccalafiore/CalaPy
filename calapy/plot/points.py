...
def single_figure_single_plot_single_format(
        x, y,
        marker_shape=None, marker_size=None, marker_color=None,
        marker_edge_width=None, marker_edge_color=None,
        line_style=None, line_color=None, line_width=None,
        ...
        ax=None, n_pixels_x=300, n_pixels_y=300, tight_layout=True):
    ...
    ax.errorbar(
        ...
        ecolor=color_error_bars, elinewidth=line_width_error_bars,
        capsize=size_caps, capthick=thickness_caps,
        linestyle=line_style, color=line_color, linewidth=line_width,
        marker=marker_shape, markerfacecolor=marker_color, markersize=marker_size,
...
def single_figure_single_plot_multi_formats(
        x, y, axes,
        marker_shapes=None, marker_sizes=None, marker_colors=None,
        marker_edge_widths=None, marker_edge_colors=None,
    ...
    # format axes
    keys_axes_expected = np.asarray(['formats', 'points'], dtype='U')
    ...
    if axes.get('formats') is None:
        if axes.get('points') in values_axes_expected:
    ...
    if error_bars_x is None:
        ...
        symmetric_error_bars_x = True
        indexes_error_bars_x = None
        error_bars_x = [error_bars_x] * shape_y[axes['points']]
    ...
    if error_bars_y is None:
        ...
        symmetric_error_bars_y = True
        indexes_error_bars_y = None
        error_bars_y = [error_bars_y] * shape_y[axes['points']]
    ...
    dict_parameters_j = dict(
        marker_shapes=marker_shapes, marker_sizes=marker_sizes, marker_colors=marker_colors,
        marker_edge_widths=marker_edge_widths, marker_edge_colors=marker_edge_colors,
    ...
    marker_shapes = dict_parameters_j['marker_shapes']
    marker_sizes = dict_parameters_j['marker_sizes']
    marker_colors = dict_parameters_j['marker_colors']
    marker_edge_widths = dict_parameters_j['marker_edge_widths']
    marker_edge_colors = dict_parameters_j['marker_edge_colors']
    line_styles = dict_parameters_j['line_styles']
    line_colors = dict_parameters_j['line_colors']
    line_widths = dict_parameters_j['line_widths']
    ...
    indexes_jp_j[axes['points']] = slice(0, shape_y[axes['points']], 1)
    ...
    for j in range(n_formats):
        ...
        single_figure_single_plot_single_format(
            x[tuple_indexes_jp_j], y[tuple_indexes_jp_j],
            marker_shape=marker_shapes[j], marker_size=marker_sizes[j], marker_color=marker_colors[j],
            marker_edge_width=marker_edge_widths[j], marker_edge_color=marker_edge_colors[j],
            line_style=line_styles[j], line_color=line_colors[j], line_width=line_widths[j],
...
def single_figure_multi_plots_single_format(
    ...
    # format axes
    keys_axes_expected = np.asarray(['rows', 'columns', 'points'], dtype='U')
    n_keys_axes_expected = keys_axes_expected.size
    values_axes_expected = np.arange(start=0, stop=n_keys_axes_expected, step=1, dtype='i')
    if not isinstance(axes, dict):
        raise TypeError('The type of "axes" has to be dict')
    ...
    marker_shapes = dict_parameters_rc['marker_shapes']
    marker_sizes = dict_parameters_rc['marker_sizes']
    marker_colors = dict_parameters_rc['marker_colors']
    marker_edge_widths = dict_parameters_rc['marker_edge_widths']
    marker_edge_colors = dict_parameters_rc['marker_edge_colors']
    line_styles = dict_parameters_rc['line_styles']
    line_colors = dict_parameters_rc['line_colors']
    line_widths = dict_parameters_rc['line_widths']
    ...
    indexes_rcp_i[axes['points']] = slice(0, None, 1)
    ...
    for combination_rc_i in cp_combinations.n_conditions_to_combinations_on_the_fly(shape_rc):
        ...
        single_figure_single_plot_single_format(
            ...
            marker_shape=marker_shapes[tuple_indexes_rc_i], marker_size=marker_sizes[tuple_indexes_rc_i],
            marker_color=marker_colors[tuple_indexes_rc_i], marker_edge_width=marker_edge_widths[tuple_indexes_rc_i],
            marker_edge_color=marker_edge_colors[tuple_indexes_rc_i], line_style=line_styles[tuple_indexes_rc_i],
            line_color=line_colors[tuple_indexes_rc_i], line_width=line_widths[tuple_indexes_rc_i],
...
def single_figure_multi_plots_multi_formats(
    ...
    # format axes
    keys_axes_expected = np.asarray(['rows', 'columns', 'formats', 'points'], dtype='U')
    n_keys_axes_expected = keys_axes_expected.size
    values_axes_expected = np.arange(start=0, stop=n_keys_axes_expected, step=1, dtype='i')
    if not isinstance(axes, dict):
        raise TypeError('The type of "axes" has to be dict')
    ...
    marker_shapes = dict_parameters_rcj['marker_shapes']
    marker_sizes = dict_parameters_rcj['marker_sizes']
    marker_colors = dict_parameters_rcj['marker_colors']
    marker_edge_widths = dict_parameters_rcj['marker_edge_widths']
    marker_edge_colors = dict_parameters_rcj['marker_edge_colors']
    line_styles = dict_parameters_rcj['line_styles']
    line_colors = dict_parameters_rcj['line_colors']
    line_widths = dict_parameters_rcj['line_widths']
    ...
    dict_parameters_rc = dict(
        ...
        n_columns_legends=n_columns_legends)
    ...
    indexes_rcjp_i[axes['points']] = slice(0, None, 1)
    ...
    axes_next = {}
    if axes['formats'] < axes['points']:
        axes_next['formats'] = 0
        axes_next['points'] = 1
    elif axes['formats'] > axes['points']:
        axes_next['formats'] = 1
        axes_next['points'] = 0
    ...
    for combination_rc_i in cp_combinations.n_conditions_to_combinations_on_the_fly(shape_rc):
        ...
        single_figure_single_plot_multi_formats(
            ...
            marker_shapes=marker_shapes[tuple_indexes_rcj_i], marker_sizes=marker_sizes[tuple_indexes_rcj_i],
            marker_colors=marker_colors[tuple_indexes_rcj_i],
            marker_edge_widths=marker_edge_widths[tuple_indexes_rcj_i],
            marker_edge_colors=marker_edge_colors[tuple_indexes_rcj_i], line_styles=line_styles[tuple_indexes_rcj_i],
            line_colors=line_colors[tuple_indexes_rcj_i], line_widths=line_widths[tuple_indexes_rcj_i],
            error_bars_x=error_bars_x_i, error_bars_y=error_bars_y_i,
...
def multi_figures_single_plot_single_format(
        ...
        mins_x=None, maxes_x=None, mins_y=None, maxes_y=None,
        legends=False, labels_legends=None, locations_legends='best', font_sizes_legends=None, n_columns_legends=1,
        id_figures=None, n_pixels_x=300, n_pixels_y=300, tight_layouts=True):

    # todo: """ """
    """"""

    # format axes
    keys_axes_expected = np.asarray(['figures', 'points'], dtype='U')
    n_keys_axes_expected = keys_axes_expected.size
    values_axes_expected = np.arange(start=0, stop=n_keys_axes_expected, step=1, dtype='i')
    if not isinstance(axes, dict):
        raise TypeError('The type of "axes" has to be dict')
    ...
    marker_shapes = dict_parameters_f['marker_shapes']
    marker_sizes = dict_parameters_f['marker_sizes']
    marker_colors = dict_parameters_f['marker_colors']
    marker_edge_widths = dict_parameters_f['marker_edge_widths']
    marker_edge_colors = dict_parameters_f['marker_edge_colors']
    line_styles = dict_parameters_f['line_styles']
    line_colors = dict_parameters_f['line_colors']
    line_widths = dict_parameters_f['line_widths']
    ...
    indexes_fp_f[axes['points']] = slice(0, shape_y[axes['points']], 1)
    ...
    for f in range(n_figures):
        ...
        single_figure_single_plot_single_format(
            ...
            marker_shape=marker_shapes[f], marker_size=marker_sizes[f], marker_color=marker_colors[f],
            marker_edge_width=marker_edge_widths[f], marker_edge_color=marker_edge_colors[f],
            line_style=line_styles[f], line_color=line_colors[f], line_width=line_widths[f],
            ...
            n_pixels_x='not needed', n_pixels_y='not needed', tight_layout=tight_layouts[f])
...
def multi_figures_multi_plots_single_format(
        ...
        add_letters_to_titles=True, letter_start_titles=None, template_letter_addition_titles=None,
        n_pixels_x=300, n_pixels_y=300, tight_layouts=True):


    # format axes
    keys_axes_expected = np.asarray(['figures', 'rows', 'columns', 'points'], dtype='U')
    n_keys_axes_expected = keys_axes_expected.size
    values_axes_expected = np.arange(start=0, stop=n_keys_axes_expected, step=1, dtype='i')
    if not isinstance(axes, dict):
        raise TypeError('The type of "axes" has to be dict')
    ...
    marker_shapes = dict_parameters_frc['marker_shapes']
    marker_sizes = dict_parameters_frc['marker_sizes']
    marker_colors = dict_parameters_frc['marker_colors']
    marker_edge_widths = dict_parameters_frc['marker_edge_widths']
    marker_edge_colors = dict_parameters_frc['marker_edge_colors']
    line_styles = dict_parameters_frc['line_styles']
    line_colors = dict_parameters_frc['line_colors']
    line_widths = dict_parameters_frc['line_widths']
    ...
    for f in range(n_figures):
        ...
        single_figure_multi_plots_single_format(
            ...
            marker_shapes=marker_shapes[tuple_indexes_frc_f], marker_sizes=marker_sizes[tuple_indexes_frc_f],
            marker_colors=marker_colors[tuple_indexes_frc_f],
            marker_edge_widths=marker_edge_widths[tuple_indexes_frc_f],
            marker_edge_colors=marker_edge_colors[tuple_indexes_frc_f],
            line_styles=line_styles[tuple_indexes_frc_f], line_colors=line_colors[tuple_indexes_frc_f],
            line_widths=line_widths[tuple_indexes_frc_f],
            error_bars_x=error_bars_x_f, error_bars_y=error_bars_y_f,
            ...
            n_pixels_x=n_pixels_x[f], n_pixels_y=n_pixels_y[f], tight_layout=tight_layouts[f])
