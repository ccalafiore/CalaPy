...
__all__ = ['SequentialGRUs', 'ParallelGRUs', 'SequentialGRUsParallelGRUs']


# todo: add non-trainable layers

class SequentialGRUs(cp_ModelMethods):
...
class ParallelGRUs(cp_ModelMethods):
...
class SequentialGRUsParallelGRUs(cp_ModelMethods):
    ...
    def __init__(
        ...
        superclass = SequentialGRUsParallelGRUs
        try:
            # noinspection PyUnresolvedReferences
            self.superclasses_initiated
        except AttributeError:
